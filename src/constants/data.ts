...
export interface CarDataSchema {
   Manufacturer: string;
   Model: string;
   Sales_in_thousands: NumberString;
   __year_resale_value: NumberString;
   Vehicle_type: string;
   Price_in_thousands: NumberString;
   Engine_size: NumberString;
   Horsepower: NumberString;
   Wheelbase: NumberString,
   Width: NumberString,
   Length: NumberString
   Curb_weight: NumberString,
   Fuel_capacity: NumberString,
   Fuel_efficiency: NumberString,
   Latest_Launch: DateString,
   Power_perf_factor: string;
}

// Deal with missing values using Partial
export const sourceData: CarDataSchema[] = [
   {
       "Manufacturer": "Acura",
       "Model": "Integra",
